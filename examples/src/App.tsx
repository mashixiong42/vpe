...
import { bold } from '@vpe/extensions'
import './App.css'
...
const { boldTesterConfig } = bold

const eventBus = createEventBus()

eventBus.on(boldTesterConfig.resultEventName, (data: any) => console.log('bold test result handler', data))

const boldTester = createStateTesterPlugin(boldTesterConfig)
